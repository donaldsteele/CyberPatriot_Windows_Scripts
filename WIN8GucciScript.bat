...
:: Startup Task
schtasks /create /tn fortnite /tr %desktop%\WIN8GucciScript.bat /sc onlogon /rl highest /f
...
LGPO /g "%scm%\Win8\Computer_Sec"
LGPO /g "%scm%\Win8\Domain_Sec"
LGPO /g "%scm%\Win8\User_Sec"
LGPO /g "%scm%\Win8\BitLocker_Sec"
cls
